...
namespace Курсовая_работа_по_методам_программирования
{
    public partial class Addendum : Form
    {
        ...
        { 
            ...
            Kod_book1.Value = Main_menu.count_ID;
            Main_menu.count_ID++;
            try
            {
            ...
            {
                MessageBox.Show("Введите полную информацию или проверьте всё ли верно введено "+ ex); //либо показывать свою строку
                return;
            }
        ...
        {   Main_menu Main_menu = new Main_menu();
            ...
            Main_menu.dataGridView1.Rows.Add(Kod_book1, Name_book1, Name_writer1, Data_create1, Nom_stellach1, Nom_shkaf1, Nom_polki1);
        }
